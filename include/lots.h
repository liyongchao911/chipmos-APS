...
protected:
    ...
    static std::map<std::string, int> getModelsDistribution(std::map<std::string, std::map<std::string, std::vector<entity_t *> > > ents); //location -> amount
    static std::map<std::string, int> getModelsDistribution(std::map<std::string, std::vector<entity_t *> > loc_ents);
    ...
    std::vector<lot_t> queueTimeAndQueue(std::vector<lot_t> lots,
                                    ...
                                    da_stations_t &das,
                                    route_t routes);
    void setCanRunModels(std::string bdid_model_mapping_models_filename, std::vector<lot_t> &lots, std::vector<lot_t> &faulty_lots);
    ...
    void setUph(std::string uph_file_name, std::vector<lot_t> &lots, std::vector<lot_t> & faulty_lots);
public:
